...
namespace CargoTransportation.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(CargoTransportationContext context)
        {
            _context = context;
        }

        // GET: Employees
        public async Task<IActionResult> Index(string position, int page = 1)
        {
            var pageSize = 10;
            ...
            {
                employees = employees.Where(e => e.Position.StartsWith(position));
            }
            ...
            { 
                ...
                EmployeeFilter = new EmployeeFilter(position)
            });
        }
